...
4. **External Geocoding** (`LocationIqService`):
     ...
     * Only if tiers 1â€“3 miss, a request is sent to LocationIQ. The normalized address (`road, suburb, neighbourhood, city, county`) is saved into `location_cache` for future fleet-wide reuse.
...
3. **Open Thunder Client**: Click the lightning bolt icon (âš¡) on the left sidebar &rarr; click **New Request**.
